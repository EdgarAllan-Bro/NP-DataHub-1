...
export default function Profile() {
  ...
  const inputProps = {
    ...
    value: userData.city,
    onChange: onChange,
    className: "w-3/4 mt-1 px-3 py-2 text-white-900 bg-gray-500 rounded-md "
  };
  ...
  const NteeInputProps = {
    ...
    className: "w-3/4 px-3 py-2 text-white-900 bg-gray-500 rounded-md"
  };
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-3/4 mt-1 px-3 py-2 text-white-900 bg-gray-500 rounded-md flex"
                />
                <button
                  type="button"
                  onClick={uploadFile}
              ...
              <div>
                ...
                <input
                  ...
                  value={userData.zip}
                  onChange={handleChange}
                  className="w-3/4 mt-1 px-3 py-2 text-white-900 bg-gray-500 before:rounded-md"
                />
              </div>
              <div>
              ...
              <button
                type="submit"
                className="w-3/4 px-4 py-2 text-white font-medium bg-gray-800 rounded-md hover:bg-indigo-700 transition duration-300"
              >
